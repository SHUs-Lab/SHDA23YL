...
for ii in range(4):
    ...
    np.save(f"./Data4Area5C/{states[ii]}_Norm_data5C.npy", NormData) # normalized data (num,100,100,5) images, 5 channels: 0-4 is DEM,RGB,NIR
    np.save(f"./Data4Area5C/{states[ii]}_NDVI.npy", NDVI)
    np.save(f"./Data4Area5C/{states[ii]}_NDWI.npy", NDWI)
